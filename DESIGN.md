...
colors:
  # 2026-09 rebrand. Brand: Deep Teal #087F83, Soft Teal #4FA7A3,
  # Dark Chocolate #2B211D, Muted Peach #E7A58A, Vanilla Cream #F5EEDB.
  # The prose below still describes the old dark-first "green room" direction
  # and is pending a rewrite; the values here are current.
  action-teal: "#087F83"
  action-teal-strong: "#066A6D"
  signal-peach: "#E7A58A"
  signal-peach-strong-light: "#9A4E34"
  signal-peach-strong-dark: "#F0B9A2"
  accent-teal: "#4FA7A3"
  on-peach: "#2B211D"
  ...
  status-info: "#3A82F6"
  choc-page: "#1B1310"
  choc-page-subtle: "#201814"
  choc-surface: "#261C18"
  choc-card: "#2B211D"
  choc-card-muted: "#322722"
  choc-border: "#3A2E28"
  choc-text: "#F5EEDB"
  choc-text-muted: "#A99B8E"
  cream-page: "#F5EEDB"
  cream-page-subtle: "#EFE6CF"
  cream-surface: "#FBF7EA"
  cream-card-muted: "#F1E8D2"
  cream-footer: "#EBE1C8"
  cream-text: "#2B211D"
  cream-text-secondary: "#4E4039"
  cream-text-muted: "#6E5F55"
  logo-chocolate: "#2B211D"
typography:
  display:
