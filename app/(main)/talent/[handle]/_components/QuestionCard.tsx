...
export default function QuestionCard({ talentId }: { talentId: string }) {
    ...
    <div style={{ backgroundColor: CARD, border: `1px solid ${BORDER}`, borderRadius: 16, padding: 22, textAlign: "center" }}>
      ...
      <ProtectedAction action="start_conversation">
        <motion.button
          ...
          style={{ backgroundColor: "transparent", color: MUTED, border: `1px solid ${BORDER}`, borderRadius: 10, padding: "11px 0", width: "100%", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "'Cairo',sans-serif", transition: "all 0.2s" }}>
