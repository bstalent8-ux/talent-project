    ...
    <div style={{ backgroundColor: BG, border: `1px solid ${BORDER}`, borderRadius: 16, padding: "20px 24px", fontFamily: "'IBM Plex Sans Arabic',sans-serif", direction: ar ? "rtl" : "ltr" }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <button type="submit" disabled={sending || !rating}
          style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: !rating ? MUTED : "var(--color-primary)", color: "var(--color-primary-ink)", border: "none", borderRadius: 10, padding: "12px 0", fontSize: 14, fontWeight: 900, cursor: sending || !rating ? "default" : "pointer", opacity: !rating ? 0.5 : 1, fontFamily: "'IBM Plex Sans Arabic',sans-serif" }}>
