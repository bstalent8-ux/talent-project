...
// Sprint 1 (profile-category-foundation) fix, extracted as a pure function so
// it is regression-tested without jsdom/React Testing Library — neither is
// set up in this project (vitest.config.ts: "No jsdom and no React renderer").
//
